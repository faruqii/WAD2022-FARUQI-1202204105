        ...
        <div class="d-flex justify-content-around">
            ...
            <div class="col-3 m-1">
                <div class="card shadow-sm rounded">
                    ...
                    <hr class="m-0">
                    <p class="m-2" style="text-align: center; color: #f9a825;">Comfortable</p>
                    <hr class="m-0">
            ...
            <div class="col-3 m-1 ms-2 me-2">
                <div class="card shadow-sm rounded">
                    ...
                    <hr class="m-0">
                    <p class="m-2" style="text-align: center; color: #f9a825;">7 Seat</p>
                    <hr class="m-0">
                    <p class="m-2" style="text-align: center; color: #f9a825;">Powerful Engine</p>
                    <hr class="m-0">
                    <p class="m-2" style="text-align: center; color: #f9a825;">Adventure Design</p>
                    <hr class="m-0">
                    <div class="text-center bg-light">
            ...
            <div class="col-3 m-1">
                <div class="card shadow-sm rounded">
                    ...
                    <p class="m-2" style="text-align: center; color: #f9a825;">7 Seat</p>
                    <hr class="m-0">
                    <p class="m-2" style="text-align: center; color: #f9a825;">Full AC</p>
                    <hr class="m-0">
                    <p class="m-2" style="text-align: center; color: #f9a825;">Fun to Drive</p>
                    <hr class="m-0">
                    <div class="text-center bg-light">
